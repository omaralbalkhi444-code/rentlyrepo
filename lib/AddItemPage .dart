...
class _AddItemPageState extends State<AddItemPage> {
  ...
  final TextEditingController itemOriginalPriceController = TextEditingController();
  ...
  void initState() {
    ...
    if (widget.existingItem != null) {
      ...
      if (data["insurance"] != null) {
        ...
        itemOriginalPriceController.text = insuranceData["itemOriginalPrice"]?.toString() ?? "";
      }
    }
  }
  ...
  double calculateInsuranceAmount() {
    if (itemOriginalPriceController.text.isEmpty) {
      return 0.0;
    }
    
    final originalPrice = double.tryParse(itemOriginalPriceController.text) ?? 0.0;
  ...
  Future<void> saveItem() async {
    ...
    if (itemOriginalPriceController.text.isEmpty) return showError("Enter item original price");
    
    final originalPrice = double.tryParse(itemOriginalPriceController.text);
  ...
  Widget buildInsuranceSection() {
    final insuranceAmount = calculateInsuranceAmount();
    final itemPriceText = itemOriginalPriceController.text;
